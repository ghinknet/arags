...
def main():
        ...
        available_charaters = {'Anmicius', 'Camil', 'Grey', 'King', 'Ray'}#这里是目前支持的角色列表
		#Anmicius安迷修，Camil卡米尔，Grey格瑞，King金，Ray雷狮
        ...
        output_dir = os.path.join(os.getcwd() ,'arags')#这里是保存目录，默认保存到arags目录下
